...
def get_all_patterns():
    return {
        "melody": {
            ...
            "patterns": {
                "A": [  # 기본 테마
                    ("C5",0.5),("D#5",0.5),("G5",1.0),
                    ("F5",0.5),("D#5",0.5),("C5",0.5),("D5",0.5),
                    ("D#5",1.0),("C5",0.5),("G4",0.5),
                    ("G#4",0.5),("A#4",0.5),("G4",1.0),
                ],
                "B": [  # 상승형 변주
                    ("G4",0.5),("A#4",0.5),("C5",0.5),("D5",0.5),
                    ("D#5",1.5),("F5",0.5),
                    ("G5",1.0),("F5",0.5),("D#5",0.5),
                    ("D5",0.5),("C5",0.5),("A#4",1.0),
                ],
                "C": [  # 고음 클라이막스
                    ("G5",1.0),("A#5",0.5),("G5",0.5),
                    ("F5",0.5),("D#5",0.5),("F5",1.0),
                    ("D#5",0.5),("C5",0.5),("D#5",0.5),("G5",0.5),
                    ("A#5",1.0),("G5",1.0),
                ],
            },
        },
        ...
        "harmony": {
            ...
            "patterns": {
                "A": [  # 부드러운 대선율
                    ("D#4",1.0),("G4",1.0),
                    ("F4",0.5),("D#4",0.5),("D4",1.0),
                    ("C4",1.0),("D#4",0.5),("D4",0.5),
                    ("C4",1.0),("R",1.0),
                ],
                "B": [  # 리듬감 있는 변주
                    ("G4",0.25),("R",0.25),("G4",0.25),("R",0.25),
                    ("D#4",0.25),("R",0.25),("D#4",0.25),("R",0.25),
                    ("F4",0.25),("R",0.25),("F4",0.25),("R",0.25),
                    ("D4",0.5),("C4",0.5),("D4",0.5),("D#4",0.5),
                    ("C4",1.0),("R",1.0),
                ],
                "C": [  # 옥타브 위 대선율
                    ("D#5",0.5),("G5",0.5),("D#5",0.5),("C5",0.5),
                    ("G4",1.0),("G#4",1.0),
                    ("A#4",0.5),("C5",0.5),("D#5",0.5),("C5",0.5),
                    ("G4",1.0),("R",1.0),
                ],
            },
        },
        ...
        "bass": {
            ...
            "patterns": {
                "A": [  # 루트 기반 워킹 베이스
                    ...
                    ("G#2",1.0),("G#2",0.5),("G#3",0.5),
                    ("A#2",1.0),("A#2",0.5),("A#3",0.5),
                    ("G2",1.0),("G2",0.5),("G3",0.5),
                ],
                "B": [  # 8분음표 펄스 베이스
                    ("C2",0.5),("C3",0.5),("C2",0.5),("D#2",0.5),
                    ("G#2",0.5),("G#3",0.5),("G#2",0.5),("G2",0.5),
                    ("A#2",0.5),("A#3",0.5),("F2",0.5),("F3",0.5),
                    ("G2",0.5),("G3",0.5),("G2",0.5),("G3",0.5),
                ],
                "C": [  # 크로매틱 상승 베이스
                    ("C2",1.0),("D2",0.5),("D#2",0.5),
                    ("F2",1.0),("G2",0.5),("G#2",0.5),
                    ("A#2",1.0),("C3",0.5),("A#2",0.5),
                    ("G2",1.5),("G3",0.5),
                ],
            },
        },
        ...
        "arpeggio": {
            ...
            "patterns": {
                "A": [  # 상승 아르페지오
                    ("C5",0.25),("D#5",0.25),("G5",0.25),("D#5",0.25),
                    ("C5",0.25),("D#5",0.25),("G5",0.25),("D#5",0.25),
                    ("G#4",0.25),("C5",0.25),("D#5",0.25),("C5",0.25),
                    ("G#4",0.25),("C5",0.25),("D#5",0.25),("C5",0.25),
                    ("A#4",0.25),("D5",0.25),("F5",0.25),("D5",0.25),
                    ("A#4",0.25),("D5",0.25),("F5",0.25),("D5",0.25),
                    ("G4",0.25),("A#4",0.25),("D5",0.25),("A#4",0.25),
                    ("G4",0.25),("A#4",0.25),("D5",0.25),("A#4",0.25),
                ],
                "B": [  # 느린 아르페지오 (여유)
                    ("C5",0.5),("D#5",0.5),("G5",0.5),("R",0.5),
                    ("G#4",0.5),("C5",0.5),("D#5",0.5),("R",0.5),
                    ("A#4",0.5),("D5",0.5),("F5",0.5),("R",0.5),
                    ("G4",0.5),("A#4",0.5),("D5",0.5),("R",0.5),
                ],
                "C": [  # 고속 16분음표 (클라이막스)
                    ("C6",0.25),("G5",0.25),("D#5",0.25),("C5",0.25),
                    ("D#6",0.25),("C6",0.25),("G5",0.25),("D#5",0.25),
                    ("G#5",0.25),("D#5",0.25),("C5",0.25),("G#4",0.25),
                    ("C6",0.25),("G#5",0.25),("D#5",0.25),("C5",0.25),
                    ("A#5",0.25),("F5",0.25),("D5",0.25),("A#4",0.25),
                    ("D6",0.25),("A#5",0.25),("F5",0.25),("D5",0.25),
                    ("G5",0.25),("D5",0.25),("A#4",0.25),("G4",0.25),
                    ("A#5",0.25),("G5",0.25),("D5",0.25),("A#4",0.25),
                ],
            },
        },
    }
