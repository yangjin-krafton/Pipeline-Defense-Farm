...
// 소화기관 입구 → 출구 순으로 정렬, 2개씩 짝지어 3배 상승
// 티어: 0(무료) → 200 → 600 → 1,800 → 5,400 → 16,200 → 48,600 → 145,800 → 437,400
export const TOWER_SLOTS = [
  ...
  // ── Tier 1 (200 NC) : 위 측면 ────────────────────────────
  { "x":  40, "y": 120, "radius": 20, "unlockCost":     200 },
  { "x": 330, "y": 110, "radius": 20, "unlockCost":     200 },

  // ── Tier 2 (600 NC) : 위 하단 ────────────────────────────
  { "x": 130, "y": 170, "radius": 20, "unlockCost":     600 },
  { "x": 250, "y": 170, "radius": 20, "unlockCost":     600 },

  // ── Tier 3 (1,800 NC) : 대장 상단 ────────────────────────
  { "x":  70, "y": 270, "radius": 20, "unlockCost":    1800 },
  { "x": 300, "y": 270, "radius": 20, "unlockCost":    1800 },

  // ── Tier 4 (5,400 NC) : 대장 중단 ────────────────────────
  { "x": 180, "y": 270, "radius": 20, "unlockCost":    5400 },
  { "x": 100, "y": 360, "radius": 20, "unlockCost":    5400 },

  // ── Tier 5 (16,200 NC) : 소장 상부 ───────────────────────
  { "x": 200, "y": 360, "radius": 20, "unlockCost":   16200 },
  { "x": 300, "y": 360, "radius": 20, "unlockCost":   16200 },

  // ── Tier 6 (48,600 NC) : 소장 하부 ───────────────────────
  { "x": 150, "y": 450, "radius": 20, "unlockCost":   48600 },
  { "x": 260, "y": 450, "radius": 20, "unlockCost":   48600 },

  // ── Tier 7 (145,800 NC) : 소장 말단 / 대장 시작 ──────────
  { "x":  60, "y": 450, "radius": 20, "unlockCost":  145800 },
  { "x":  80, "y": 520, "radius": 20, "unlockCost":  145800 },

  // ── Tier 8 (437,400 NC) : 대장 심부 ──────────────────────
  { "x": 180, "y": 520, "radius": 20, "unlockCost":  437400 },
  { "x": 300, "y": 510, "radius": 20, "unlockCost":  437400 },
];
