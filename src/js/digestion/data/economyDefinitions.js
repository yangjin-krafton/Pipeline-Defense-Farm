...
export const SC_CONFIG = {
  ...
  emoji: '⚡',
  // 수급 규칙
  passiveRegenPerHour: 20,          // 시간당 20 회복 (3분마다 1씩 증가), maxCap 도달 시 중단
  hourlyLoginBonus: 10,             // 60분 접속 보너스 (maxCap 초과 누적 가능)
  dailyLoginBonus: 20               // 일일 접속 보너스 (maxCap 초과 누적 가능)
};
...
// 성급별 승급 비용 (1->7성)
// 설계 의도: 초반 저렴(진입장벽 낮춤) → 후반 비싸게(도전적)
// 일일 NC 수급: 약 2,720 NC/day 기준
export const STAR_UPGRADE_COSTS = [
  { from: 1, to: 2, nc: 200, sc: 15 },   // 일일 수급의 7% (첫날부터 가능)
  { from: 2, to: 3, nc: 400, sc: 18 },   // 일일 수급의 15% (반나절)
  { from: 3, to: 4, nc: 700, sc: 22 },   // 일일 수급의 26% (하루 미만)
  { from: 4, to: 5, nc: 1200, sc: 26 },  // 일일 수급의 44% (1.5일)
  { from: 5, to: 6, nc: 2000, sc: 30 },  // 일일 수급의 74% (2일)
  { from: 6, to: 7, nc: 3500, sc: 35 }   // 일일 수급의 129% (3일, 도전적)
];
